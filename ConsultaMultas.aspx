<%@ Page Title="Consulta Multas JPL" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaMultas.aspx.vb" Inherits="Consulta.ConsultaMultas" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                    ConnectionString="<%$ ConnectionStrings:pcv %>" 
                                    SelectCommand="SELECT folio, rut, url, nombre, rol AS patente, fecha_pago 
                                                   FROM vista_pago_jpl 
                                                   WHERE (rol = @patente) 
                                                   AND (fecha_pago &gt; CONVERT(DATETIME, '2015-12-31 23:59:59', 102))">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="patente" SessionField="patente" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                <br />
                            </div>
